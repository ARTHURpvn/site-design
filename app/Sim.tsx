...
export default function Sim({name, onClick} : { name: string, onClick?: () => void }) {
    ...
    return (
        <div onClick={() => openLink()} className="relative mt-32 w-[30rem] h-40 border-2 flex items-start border-purple-500 rounded-tr-[4rem] rounded-bl-[4rem] drop-shadow-personal">
